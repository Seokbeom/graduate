...
file_name = 'movie_dialogue_40_T_18563.txt'
#file_name='movie_dialogue_15_T_9752.txt'
size = 100
...
model = word2vec.Word2Vec(size=size, seed=1234, min_count=1, workers=4, sg= 0, min_alpha=0.025, alpha=0.025 ) ## Try alpha=0.05 and cbow_mean=1  https://stackoverflow.com/questions/34249586/the-accuracy-test-of-word2vec-in-gensim
