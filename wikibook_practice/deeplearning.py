...
model.add(Conv2D(15, (3, 3), padding='same', data_format= 'channels_first', input_shape=(1,28,28) )) # 3*3필터 10개(랜덤?) 36같이 크게 주면 잘 안됨.. 이게 의미하는게 뭔지 공부 필요함
...
model.add(Conv2D(15, (3, 3))) # filter 한번 더 하기
...
model.compile(loss = 'categorical_crossentropy', #찾아봐야함
                optimizer = 'rmsprop', #찾아봐야함
                metrics=['accuracy']) # 찾아봐야함
